...
alias kds = kubectl --context=eqx-dal-stage
alias kdp = kubectl --context=eqx-dal-prod
alias kdc = kubectl --context=eqx-dal-corp
alias kes = kubectl --context=drt-ewr-stage
alias kep = kubectl --context=drt-ewr-prod
alias kec = kubectl --context=drt-ewr-corp
